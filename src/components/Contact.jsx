    ...
    >
      <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <div className='flex justify-center items-center'>
            <form action="https://getform.io/f/783418d6-c8f6-40e9-a8b2-6ca4532f00fd"
            method='post' className='flex flex-col w-full md:w-1/2'>
                <input
                 ...
                 <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-900 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300'>Let's talk</button>
            </form>
        </div>
      </div>
    </div>
